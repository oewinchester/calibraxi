...
- The 158 retained reconciliation issues are all `schedule_revision` records caused by a one-hour kickoff representation difference between the Football-Data snapshot and ESPN. Scores, home/away teams, competition, season, and fixture identity reconciled without source-conflict or duplicate-fixture promotion.
